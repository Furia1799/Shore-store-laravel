...
<section>
    ...
    <div class="container-fluid">
        ...
        <div  class="row">
            ...
            <div id="peque_descripccion_producuto" class="log-lg-4">
                <h2 class="titulo_producto">Tennis Adidas</h2>
                <p>Copa mundial</p>
                <p>Talla : 21</p>
            </div>
            <div id="cantidad_producto" class="col-lg-4">
                <form action="#">
                    <input type="number">
                </form>
            </div>
            <div id="precio_producto" class="col-lg-4">
