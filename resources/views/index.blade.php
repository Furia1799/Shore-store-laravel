...
<body>
    ...
    <section>
        ...
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top ">
            ...
            <ul class="navbar-nav ">
                <li class="nav-item">
                    <a class="nav-link" href="php/mujeres.blade.php">Mujere</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="php/hombres.blade.php">Hombre</a>
                </li>
                <li class="nav-item">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="php/registro.blade.php">
                        <button type="button" class="btn btn-info">Registrar</button>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="php/login.blade.php">
